...
class UI:
    ...
    def mainMenu(self):
        ...
        while True:
            ...
            if command == '0':
                ...
                list = self.rentC.statRents(increasing)
                for i in list:
                    print(str(i[1]))
    ...
    def filter(self):
        ...
        if n == "1":
            ...
            ino = input(">>")
            if ino == "1":
                list = self.bookC.filter(param, decreasing)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "2":
                list = self.bookC.filter(param, increasing)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "3":
                list = self.bookC.filter(param, equal)
                for i in list:
                    print(i)
                    print("- " * 10)
            else:
            ...
            ino = input(">>")
            if ino == "1":
                list = self.clientC.filter(param, decreasing)
                print(1)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "2":
                list = self.clientC.filter(param, increasing)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "3":
                list= self.clientC.filter(param, equal)
                for i in list:
                    print(i)
                    print("- " * 10)
            else:
            ...
            ino = input(">>")
            if ino == "1":
                list = self.rentC.filter(param, decreasing)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "2":
                list = self.rentC.filter(param, increasing)
                for i in list:
                    print(i)
                    print("- " * 10)
            elif ino == "3":
                list = self.rentC.filter(param, equal)
                for i in list:
                    print(i)
                    print("- " * 10)
            else:
