# Shump
# Ffdsfsdfsfdsi::::i://twitter.com/tgfcodsr> licensed under CC-BY-3
...
def show_go_screen():
    ...
    draw_text(screen, "Arrow key move,Space to fire!",
              18, WIDTH / 2, HEIGHT / 2)
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image_orgig = random.choice(meteor_images)
        self.image_orgig.set_colorkey(BLACK)
        self.image = self.image_orgig.copy()
        self.rect = self.image.get_rect()
    ...
    def rotate(self):
        ...
        if now - self.last_update > 50:
            ...
            new_image = pygame.transform.rotate(self.image_orgig, self.rot)
...
background = pygame.image.load(path.join(img_dir, "backstars.png")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(
    path.join(img_dir, "playerShip2_blue.png")).convert()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(BLACK)
bullet_img = pygame.image.load(
    path.join(img_dir, "laserGreen10.png")).convert()
meteor_images = []
meteor_list = ['big1.png', 'big2.png', 'med1.png',
               'med3.png', 'small1.png', 'small2.png', 'tiny1.png']
for img in meteor_list:
    meteor_images.append(pygame.image.load(
        path.join(img_dir, 'meteorBrown_' + img)).convert())
