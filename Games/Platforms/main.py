...
class Game:
    def __init__(self):
        ...
        self.load_data()
        self.last_dist = random.randrange(-40, -20)
    ...
    def load_data(self):
        ...
        self.jump_sound = pg.mixer.Sound(path.join(self.snd_dir, 'Jump29.wav'))
        self.boost_sound = pg.mixer.Sound(
            path.join(self.snd_dir, 'Powerup12.wav'))
    ...
    def update(self):
        ...
        while len(self.platforms) < 6:
            ...
            Platform(self, random.randrange(0, WIDTH - width),
                     self.last_dist + random.randrange(-10, 10))
            self.last_dist = random.randrange(-40, -20)
